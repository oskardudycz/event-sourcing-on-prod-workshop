...
Check in my [Event Sourcing in .NET Repository](https://github.com/oskardudycz/EventSourcing.NetCore) or on [my blog](https://event-driven.io) to find out how to do it _the right way_.
